...
type DynamicDataDynamicDataType int32

const (
	DynamicData_usage       DynamicDataDynamicDataType = 0
	DynamicData_process     DynamicDataDynamicDataType = 1
	DynamicData_connections DynamicDataDynamicDataType = 2
	DynamicData_temps       DynamicDataDynamicDataType = 3
)

// Enum value maps for DynamicDataDynamicDataType.
var (
	DynamicDataDynamicDataType_name = map[int32]string{
		0: "usage",
		1: "process",
		2: "connections",
		3: "temps",
	}
	DynamicDataDynamicDataType_value = map[string]int32{
		"usage":       0,
		"process":     1,
		"connections": 2,
		"temps":       3,
...
func (x DynamicDataDynamicDataType) Enum() *DynamicDataDynamicDataType {
	p := new(DynamicDataDynamicDataType)
	*p = x
	return p
}

func (x DynamicDataDynamicDataType) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (DynamicDataDynamicDataType) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_api_metrics_metrics_proto_enumTypes[2].Descriptor()
}

func (DynamicDataDynamicDataType) Type() protoreflect.EnumType {
	return &file_internal_api_metrics_metrics_proto_enumTypes[2]
}

func (x DynamicDataDynamicDataType) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Use DynamicDataDynamicDataType.Descriptor instead.
func (DynamicDataDynamicDataType) EnumDescriptor() ([]byte, []int) {
	return file_internal_api_metrics_metrics_proto_rawDescGZIP(), []int{12, 0}
}

type DataDataType int32

const (
	Data_static  DataDataType = 0
	Data_dynamic DataDataType = 1
)
...
func (DataDataType) Descriptor() protoreflect.EnumDescriptor {
	return file_internal_api_metrics_metrics_proto_enumTypes[3].Descriptor()
}

func (DataDataType) Type() protoreflect.EnumType {
	return &file_internal_api_metrics_metrics_proto_enumTypes[3]
}
...
func (DataDataType) EnumDescriptor() ([]byte, []int) {
	return file_internal_api_metrics_metrics_proto_rawDescGZIP(), []int{13, 0}
}
...
type StaticData struct {
	...
	Time            int64              `protobuf:"varint,1,opt,name=time,proto3" json:"time,omitempty"`                                             // 上报时间戳
	...
	Install         int64              `protobuf:"varint,7,opt,name=install,proto3" json:"install,omitempty"`                                       // 系统安装时间
	Startup         int64              `protobuf:"varint,8,opt,name=startup,proto3" json:"startup,omitempty"`                                       // 系统启动时间
	...
	Nameservers     []string           `protobuf:"bytes,19,rep,name=nameservers,proto3" json:"nameservers,omitempty"`                               // DNS服务器列表
}
...
func (x *StaticData) GetTime() int64 {
	if x != nil {
		return x.Time
	}
	return 0
...
func (x *StaticData) GetInstall() int64 {
	if x != nil {
		return x.Install
	}
	return 0
...
func (x *StaticData) GetStartup() int64 {
	if x != nil {
		return x.Startup
	}
	return 0
...
func (x *StaticData) GetNameservers() []string {
	if x != nil {
...
type DynamicPartition struct {
	...
	ReadPerSecond  float32 `protobuf:"fixed32,8,opt,name=read_per_second,json=readPerSecond,proto3" json:"read_per_second,omitempty"`    // 每秒读取字节数
	WritePerSecond float32 `protobuf:"fixed32,9,opt,name=write_per_second,json=writePerSecond,proto3" json:"write_per_second,omitempty"` // 每秒写入字节数
	IopsInProgress uint64  `protobuf:"varint,10,opt,name=iops_in_progress,json=iopsInProgress,proto3" json:"iops_in_progress,omitempty"` // 正在等待的IO操作数量
}
...
func (x *DynamicPartition) GetReadPerSecond() float32 {
	if x != nil {
...
func (x *DynamicPartition) GetWritePerSecond() float32 {
	if x != nil {
...
func (x *DynamicPartition) GetIopsInProgress() uint64 {
	if x != nil {
...
type DynamicUsage struct {
	...
	CpuLoad_1       float32             `protobuf:"fixed32,10,opt,name=cpu_load_1,json=cpuLoad1,proto3" json:"cpu_load_1,omitempty"`                  // 1分钟负载
	CpuLoad_5       float32             `protobuf:"fixed32,11,opt,name=cpu_load_5,json=cpuLoad5,proto3" json:"cpu_load_5,omitempty"`                  // 5分钟负载
	CpuLoad_15      float32             `protobuf:"fixed32,12,opt,name=cpu_load_15,json=cpuLoad15,proto3" json:"cpu_load_15,omitempty"`               // 15分钟负载
}
...
func (x *DynamicUsage) GetCpuLoad_1() float32 {
	if x != nil {
		return x.CpuLoad_1
	}
	return 0
...
func (x *DynamicUsage) GetCpuLoad_5() float32 {
	if x != nil {
		return x.CpuLoad_5
	}
	return 0
...
func (x *DynamicUsage) GetCpuLoad_15() float32 {
	if x != nil {
		return x.CpuLoad_15
	}
	return 0
...
type DynamicData struct {
	...
	Begin int64                      `protobuf:"varint,1,opt,name=begin,proto3" json:"begin,omitempty"`                                       // 采集开始时间
	End   int64                      `protobuf:"varint,2,opt,name=end,proto3" json:"end,omitempty"`                                           // 采集结束时间
	Type  DynamicDataDynamicDataType `protobuf:"varint,3,opt,name=type,proto3,enum=metrics.DynamicDataDynamicDataType" json:"type,omitempty"` // 数据类型
	// 内容
	UsageData       *DynamicUsage               `protobuf:"bytes,10,opt,name=usage_data,json=usageData,proto3" json:"usage_data,omitempty"`                   // usage数据
	ProcessesData   []*DynamicProcess           `protobuf:"bytes,11,rep,name=processes_data,json=processesData,proto3" json:"processes_data,omitempty"`       // 进程列表
	ConnectionsData []*DynamicConnection        `protobuf:"bytes,12,rep,name=connections_data,json=connectionsData,proto3" json:"connections_data,omitempty"` // 连接列表
	TempsData       []*DynamicSensorTemperature `protobuf:"bytes,13,rep,name=temps_data,json=tempsData,proto3" json:"temps_data,omitempty"`                   // 传感器温度
}
...
func (x *DynamicData) GetBegin() int64 {
	if x != nil {
		return x.Begin
	}
	return 0
...
func (x *DynamicData) GetEnd() int64 {
	if x != nil {
		return x.End
	}
	return 0
...
func (x *DynamicData) GetType() DynamicDataDynamicDataType {
	if x != nil {
		return x.Type
	}
	return DynamicData_usage
}

func (x *DynamicData) GetUsageData() *DynamicUsage {
	if x != nil {
		return x.UsageData
	}
	return nil
...
func (x *DynamicData) GetProcessesData() []*DynamicProcess {
	if x != nil {
		return x.ProcessesData
	}
	return nil
}

func (x *DynamicData) GetConnectionsData() []*DynamicConnection {
	if x != nil {
		return x.ConnectionsData
	}
	return nil
}

func (x *DynamicData) GetTempsData() []*DynamicSensorTemperature {
	if x != nil {
		return x.TempsData
	}
	return nil
...
type Data struct {
	...
	Type      DataDataType `protobuf:"varint,2,opt,name=type,proto3,enum=metrics.DataDataType" json:"type,omitempty"` // 数据类型
	ClusterId string       `protobuf:"bytes,3,opt,name=cluster_id,json=clusterId,proto3" json:"cluster_id,omitempty"` // 集群ID
	Time      int64        `protobuf:"varint,4,opt,name=time,proto3" json:"time,omitempty"`                           // 上报时间
	// 内容
	StaticData  *StaticData  `protobuf:"bytes,10,opt,name=static_data,json=staticData,proto3" json:"static_data,omitempty"`    // 静态数据
	DynamicData *DynamicData `protobuf:"bytes,11,opt,name=dynamic_data,json=dynamicData,proto3" json:"dynamic_data,omitempty"` // 动态数据
}
...
func (x *Data) GetClusterId() string {
	if x != nil {
		return x.ClusterId
	}
	return ""
...
var file_internal_api_metrics_metrics_proto_rawDesc = []byte{
	...
	,
	...
	,
	...
	0x18, 0x04, 0x20, 0x01, 0x28, 0x04, 0x52, 0x05, 0x74, 0x6f, 0x74, 0x61, 0x6c, 0x12, 0x16, 0x0a,
	0x06, 0x69, 0x6e, 0x6f, 0x64, 0x65, 0x73, 0x18, 0x05, 0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x69,
	0x6e, 0x6f, 0x64, 0x65, 0x73, 0x22, 0x8c, 0x01, 0x0a, 0x10, 0x73, 0x74, 0x61, 0x74, 0x69, 0x63,
	0x5f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x6e,
	...
	0x0d, 0x52, 0x03, 0x6d, 0x74, 0x75, 0x12, 0x14, 0x0a, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x18,
	0x04, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x66, 0x6c, 0x61, 0x67, 0x73, 0x12, 0x14, 0x0a, 0x05,
	0x61, 0x64, 0x64, 0x72, 0x73, 0x18, 0x05, 0x20, 0x03, 0x28, 0x09, 0x52, 0x05, 0x61, 0x64, 0x64,
	0x72, 0x73, 0x12, 0x10, 0x0a, 0x03, 0x6d, 0x61, 0x63, 0x18, 0x06, 0x20, 0x01, 0x28, 0x09, 0x52,
	0x03, 0x6d, 0x61, 0x63, 0x22, 0x43, 0x0a, 0x0b, 0x73, 0x74, 0x61, 0x74, 0x69, 0x63, 0x5f, 0x75,
	...
	,
	...
	0x66, 0x6f, 0x72, 0x6d, 0x56, 0x65, 0x72, 0x73, 0x69, 0x6f, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x69,
	0x6e, 0x73, 0x74, 0x61, 0x6c, 0x6c, 0x18, 0x07, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x69, 0x6e,
	0x73, 0x74, 0x61, 0x6c, 0x6c, 0x12, 0x18, 0x0a, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70,
	0x18, 0x08, 0x20, 0x01, 0x28, 0x03, 0x52, 0x07, 0x73, 0x74, 0x61, 0x72, 0x74, 0x75, 0x70, 0x12,
	...
	,
	...
	,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x04, 0x52, 0x09, 0x62, 0x79, 0x74, 0x65, 0x73, 0x52, 0x65, 0x63,
	0x76, 0x12, 0x21, 0x0a, 0x0c, 0x70, 0x61, 0x63, 0x6b, 0x65, 0x74, 0x73, 0x5f, 0x73, 0x65, 0x6e,
	...
	,
	...
	,
	...
	,
...
var file_internal_api_metrics_metrics_proto_enumTypes = make([]protoimpl.EnumInfo, 4)
var file_internal_api_metrics_metrics_proto_msgTypes = make([]protoimpl.MessageInfo, 14)
var file_internal_api_metrics_metrics_proto_goTypes = []interface{}{
	...
	(DynamicDataDynamicDataType)(0),      // 2: metrics.dynamic_data.dynamic_data_type
	(DataDataType)(0),                    // 3: metrics.data.data_type
	(*StaticCore)(nil),                   // 4: metrics.static_core
	(*StaticDisk)(nil),                   // 5: metrics.static_disk
	(*StaticPartition)(nil),              // 6: metrics.static_partition
	(*StaticInterface)(nil),              // 7: metrics.static_interface
	(*StaticUser)(nil),                   // 8: metrics.static_user
	(*StaticData)(nil),                   // 9: metrics.static_data
	(*DynamicPartition)(nil),             // 10: metrics.dynamic_partition
	(*DynamicInterface)(nil),             // 11: metrics.dynamic_interface
	(*DynamicUsage)(nil),                 // 12: metrics.dynamic_usage
	(*DynamicProcess)(nil),               // 13: metrics.dynamic_process
	(*DynamicConnection)(nil),            // 14: metrics.dynamic_connection
	(*DynamicSensorTemperature)(nil),     // 15: metrics.dynamic_sensor_temperature
...
var file_internal_api_metrics_metrics_proto_depIdxs = []int32{
	...
	4,  // 1: metrics.static_data.cores:type_name -> metrics.static_core
	5,  // 2: metrics.static_data.disks:type_name -> metrics.static_disk
	6,  // 3: metrics.static_data.partitions:type_name -> metrics.static_partition
	7,  // 4: metrics.static_data.interfaces:type_name -> metrics.static_interface
	8,  // 5: metrics.static_data.users:type_name -> metrics.static_user
	10, // 6: metrics.dynamic_usage.partitions:type_name -> metrics.dynamic_partition
	11, // 7: metrics.dynamic_usage.interfaces:type_name -> metrics.dynamic_interface
	1,  // 8: metrics.dynamic_connection.type:type_name -> metrics.dynamic_connection.connection_type
	2,  // 9: metrics.dynamic_data.type:type_name -> metrics.dynamic_data.dynamic_data_type
	12, // 10: metrics.dynamic_data.usage_data:type_name -> metrics.dynamic_usage
	13, // 11: metrics.dynamic_data.processes_data:type_name -> metrics.dynamic_process
	14, // 12: metrics.dynamic_data.connections_data:type_name -> metrics.dynamic_connection
	15, // 13: metrics.dynamic_data.temps_data:type_name -> metrics.dynamic_sensor_temperature
	3,  // 14: metrics.data.type:type_name -> metrics.data.data_type
	9,  // 15: metrics.data.static_data:type_name -> metrics.static_data
	16, // 16: metrics.data.dynamic_data:type_name -> metrics.dynamic_data
