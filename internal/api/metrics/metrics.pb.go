...
type StaticData struct {
	...
	Time            *timestamppb.Timestamp `protobuf:"bytes,2,opt,name=time,proto3" json:"time,omitempty"`                                              // 上报时间戳
	HostName        string                 `protobuf:"bytes,3,opt,name=host_name,json=hostName,proto3" json:"host_name,omitempty"`                      // 主机名
	Uptime          uint64                 `protobuf:"varint,4,opt,name=uptime,proto3" json:"uptime,omitempty"`                                         // 系统启动时长
	OsName          string                 `protobuf:"bytes,5,opt,name=os_name,json=osName,proto3" json:"os_name,omitempty"`                            // linux,windows
	PlatformName    string                 `protobuf:"bytes,6,opt,name=platform_name,json=platformName,proto3" json:"platform_name,omitempty"`          // debian,centos,...
	PlatformVersion string                 `protobuf:"bytes,7,opt,name=platform_version,json=platformVersion,proto3" json:"platform_version,omitempty"` // 7.7.1908
	Install         *timestamppb.Timestamp `protobuf:"bytes,8,opt,name=install,proto3" json:"install,omitempty"`                                        // 系统安装时间
	Startup         *timestamppb.Timestamp `protobuf:"bytes,9,opt,name=startup,proto3" json:"startup,omitempty"`                                        // 系统启动时间
	KernelVersion   string                 `protobuf:"bytes,10,opt,name=kernel_version,json=kernelVersion,proto3" json:"kernel_version,omitempty"`      // 3.10.0-1062.el7.x86_64
	Arch            string                 `protobuf:"bytes,11,opt,name=arch,proto3" json:"arch,omitempty"`                                             // amd64,i386,...
	PhysicalCpu     uint64                 `protobuf:"varint,12,opt,name=physical_cpu,json=physicalCpu,proto3" json:"physical_cpu,omitempty"`           // 物理核心数
	LogicalCpu      uint64                 `protobuf:"varint,13,opt,name=logical_cpu,json=logicalCpu,proto3" json:"logical_cpu,omitempty"`              // 逻辑核心数
	Cores           []*StaticCore          `protobuf:"bytes,14,rep,name=cores,proto3" json:"cores,omitempty"`                                           // CPU核心列表
	Disks           []*StaticDisk          `protobuf:"bytes,15,rep,name=disks,proto3" json:"disks,omitempty"`                                           // 磁盘列表
	Partitions      []*StaticPartition     `protobuf:"bytes,16,rep,name=partitions,proto3" json:"partitions,omitempty"`                                 // 分区列表
	Gateway         string                 `protobuf:"bytes,17,opt,name=gateway,proto3" json:"gateway,omitempty"`                                       // 网关地址
	Interfaces      []*StaticInterface     `protobuf:"bytes,18,rep,name=interfaces,proto3" json:"interfaces,omitempty"`                                 // 网卡列表
	Users           []*StaticUser          `protobuf:"bytes,19,rep,name=users,proto3" json:"users,omitempty"`                                           // 用户列表
}
...
func (x *StaticData) GetAgentId() string {
	if x != nil {
		return x.AgentId
	}
	return ""
...
var file_internal_api_metrics_metrics_proto_rawDesc = []byte{
	...
	0x03, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x67, 0x69, 0x64, 0x22, 0xf5, 0x05, 0x0a, 0x0b, 0x73,
	0x74, 0x61, 0x74, 0x69, 0x63, 0x5f, 0x64, 0x61, 0x74, 0x61, 0x12, 0x19, 0x0a, 0x08, 0x61, 0x67,
	...
	,
	...
	0x73, 0x6b, 0x73, 0x18, 0x0f, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x65, 0x74, 0x72,
	...
	0x69, 0x6f, 0x6e, 0x73, 0x18, 0x10, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x6d, 0x65, 0x74,
	...
	0x73, 0x12, 0x18, 0x0a, 0x07, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x18, 0x11, 0x20, 0x01,
	0x28, 0x09, 0x52, 0x07, 0x67, 0x61, 0x74, 0x65, 0x77, 0x61, 0x79, 0x12, 0x39, 0x0a, 0x0a, 0x69,
	0x6e, 0x74, 0x65, 0x72, 0x66, 0x61, 0x63, 0x65, 0x73, 0x18, 0x12, 0x20, 0x03, 0x28, 0x0b, 0x32,
	...
	0x13, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x14, 0x2e, 0x6d, 0x65, 0x74, 0x72, 0x69, 0x63, 0x73, 0x2e,
